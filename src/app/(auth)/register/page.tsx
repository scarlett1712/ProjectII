...
export default function RegisterPage() {
  ...
  const [chatMessages, setChatMessages] = useState<Array<{ role: "USER" | "ASSISTANT"; content: string }>>([
    { role: "ASSISTANT", content: "Xin chào! Mình là Star. Bạn cần hỗ trợ đăng ký chỗ nào không?" },
  ]);
    ...
    <StarBackground>
      <div className="flex min-h-screen items-center justify-center p-5">
        <div className="w-full max-w-[420px] rounded-[28px] bg-white p-8 shadow-[0_20px_60px_rgba(100,70,180,0.18)]">
          <h1 className="mb-1 text-center text-3xl font-bold text-[#A172FD]">Tạo tài khoản</h1>
          <p className="mb-7 text-center text-sm text-[#9ca3af]">Chào mừng đến với thế giới của những vì sao!!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="lilstar1712@gmail.com"
            ...
            <div>
              <label htmlFor="confirm" className="mb-1 block text-sm font-medium text-[#374151]">Xác minh mật khẩu *</label>
              <div className="relative">
                <input
          ...
          <p className="mt-5 text-center text-sm text-[#6b7280]">
            Đã là của nhau?{" "}
            <Link href="/login" className="font-semibold text-[#A172FD] hover:underline">Đăng nhập</Link>
          </p>
        </div>
      </div>
